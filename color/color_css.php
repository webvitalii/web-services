...
<div style="background-color:#1e1e1e; color:#fff; padding:10px;">
<h3>RGB hex color representation via CSS</h3>
...
<p>Color value (r%,g%,b%) can be represented in percents of float range 0.0% - 100.0%.<br>
	...
	&lt;span style="color:rgb(200%,100.0%,-100%);"&gt;<span style="color:rgb(200%,100.0%,-100%);">same as rgb(100%,100%,0%)</span>&lt;/span&gt;
	</p>
<p>Color value in RGB color model can be extended with alpha-value (r,g,b,a) what adds transparency to the color. Alpha-value has float range 0.0-1.0. Can be used with both previous variants. Not supported by some browsers.<br>
	...
	&lt;span style="color:rgba(100%,100%,0%,0.25);"&gt;<span style="color:rgba(100%,100%,0%,0.25);">very transparent</span>&lt;/span&gt;
	</p>
...
<p><strong>Examples</strong>: <br>
	...
	&lt;span style="color:hsl(0,100%,0%);"&gt;<span style="color:hsl(0,100%,0%);">black text</span>&lt;/span&gt;
	</p>
...
<p><strong>Examples</strong>: <br> <br>
	...
	&lt;span style="color:hsla(60,50%,50%,0.25);"&gt;<span style="color:hsla(60,100%,50%,0.25);">very transparent</span>&lt;/span&gt;
	</p>
</div>

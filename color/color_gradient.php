...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
		$('#picker1').farbtastic('#hexcolor1');
		$('#picker2').farbtastic('#hexcolor2');
	});
</script>
...
// first color validation
 	if ((!isset($_GET['mode1']) && ($_GET['hex1'])) || (($_GET['mode1']=='hex1') && (!$_GET['hex1']=='')) ) {
		...
		<table>
			...
			<tr>
				...
				<td style="border-right:1px solid #fff;">
					<label>
						<input class="text medium_width" type="text" name="hex1" id="hexcolor1" value="<?php 
				...
				<td>
					<label>
						<input class="text medium_width" type="text" name="hex2" id="hexcolor2" value="<?php 
